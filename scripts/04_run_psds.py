...
# ============================================================================
# P8G1 production PhaseSource boundary
# ============================================================================

def _p8g1_sha256_file(
    path,
):
...
def _p8g1_write_phase_source_token(
    *,
    outdir,
    config_path,
    backend,
...
class _P8G1PhaseSourceYXTProxy:
    """
    ...
    def __init__(
        ...
        *,
        ...
        # P8E2 already fingerprints mmap-like sources through
...
def main():
    ...
    #
    # Prepared tile-wise by 04_prepare_ds_statistics.py.
    ...
    for required in (
        ...
        if not required.is_file():
            raise FileNotFoundError(
                ...
                f"{required}\n"
                "Run scripts/04_prepare_ds_statistics.py first."
            )
    ...
    # ---------------------------------------------------------
    # ---------------------------------------------------------
    # P8G1 production PhaseSource selection.
    #
    # auto:
    ...
    if (
        ...
        _phase_source_token = (
            _p8g1_write_phase_source_token(
                outdir=outdir,
        ...
        if not yxt_path.is_file():
            raise FileNotFoundError(
                ...
                "Run the phase_cache stage (scripts/03_build_phase_cache.py) first."
            )
    ...
    if temporal_strategy == "sequential":
        ...
        if args.resume:
            print(
                ...
                "production; Step04 is rebuilt deterministically."
            )
