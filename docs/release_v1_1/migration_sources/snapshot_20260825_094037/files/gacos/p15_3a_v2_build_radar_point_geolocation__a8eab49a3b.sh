...
JSON_REPORT=$LOGDIR/P15_3A_v2_radar_point_geolocation_${STAMP}.json
TXT_REPORT=$LOGDIR/P15_3A_v2_radar_point_geolocation_${STAMP}.txt
GAMMA_LOG=$LOGDIR/P15_3A_v2_gc_map_inversion_${STAMP}.log

mkdir -p "$LOGDIR"

echo "================================================================================================"
echo " P15-3A v2 BUILD RADAR-POINT GEOLOCATION"
echo
...
PY=/tmp/p15_3a_v2_build_radar_point_geolocation.py
...
# ------------------------------------------------------------------------------
# Syntax gate BEFORE any GAMMA execution
# ------------------------------------------------------------------------------
