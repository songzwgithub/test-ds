...
print('=' * 92)
print('5B3B GAMMA BASE_ORBIT REGENERATION')
print('=' * 92)
...
print('report                   :', REPORT)
print('=' * 92)
print('5B3B FINAL RESULT: PASS_COMPLETE_108_GAMMA_BASE_MODELS')
print('=' * 92)
