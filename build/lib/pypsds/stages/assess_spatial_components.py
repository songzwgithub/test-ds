...
def main():
    ...
    print("=" * 88)
    print(
        "R=4 residual spatial-component quality"
    )
    print("=" * 88)
    ...
    summary = {
        "format":
            "pyPSDS-GAMMA-residual-spatial-quality-v1.0",
    ...
    print()
    print(
        "STEP spatial_component_quality STATUS: PASS"
    )
