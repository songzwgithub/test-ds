...
def choose_pair(quality_csv: Path, pair_id: int):
    rows = []
...
def main():
    ...
    print("=" * 96)
    print(
        "Safe-fragment integer consistency quality"
    )
    print("=" * 96)
    ...
    print()
    print(
        "safe fragment topology baseline bad edges     : 132"
    )

    print(
        f"safe fragment quality consensus bad edges    : "
        f"{full_bad}"
    )

    print(
        f"change vs safe fragment topology              : "
        f"{full_bad-132:+d}"
    )

    # ========================================================
    # Super-edge constraint quality
    # ========================================================
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-safe-fragment-integer-quality-v1.0",

        "status":
            "PRODUCTION_NOT_FROZEN",
        ...
        "consensus_solution": {
            ...
            "baseline_safe fragment topology_bad_edges":
                132,
        },
    }
    ...
    print()
    print(
        "STEP safe_fragment_quality STATUS: PASS / PRODUCTION ONLY"
    )

    print(
        "Do not batch-unwrap temporal-network IFGs yet."
    )
