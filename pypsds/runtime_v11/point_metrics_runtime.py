...
if final_manifest.get('status') != 'PASS_FINAL_REFERENCED_LOS_TIMESERIES':
    raise RuntimeError('P15-6C is not frozen PASS')
...
if dates[0] != '20141006':
    raise RuntimeError(f'frozen temporal datum changed: {dates[0]}')
...
print('velocity                        :', 'OLS all 38 epochs + intercept')
...
print('=' * 96)
print('P15-7A FINAL RESULT: PASS_FINAL_LOS_POINT_PRODUCTS')
print('=' * 96)
