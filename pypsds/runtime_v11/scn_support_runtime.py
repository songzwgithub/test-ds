...
COUNT_OUT = OUTDIR / 'stage8_neighbor_count_r400m.npy'
MANIFEST = OUTDIR / 'p15_6b0_exact_neighbor_census.json'
RADIUS = 400.0
SIGMA = 100.0
QUERY_CHUNK = 65536
A = 6378137.0
...
naive_point_epoch_interactions = directed_interactions * 38
if directed_interactions <= 500000000:
    recommendation = 'BENCHMARK_CKDTREE_STREAMING_EXACT'
elif candidate_to_true_ratio <= 1.8:
    recommendation = 'BENCHMARK_NUMBA_CELL_LIST_EXACT_FIRST'
else:
    recommendation = 'BENCHMARK_CELL_LIST_VS_CKDTREE_EXACT'
...
print('naive interactions ×38 epochs :', f'{naive_point_epoch_interactions:,}')
print()
print('400m cell grid                 :', f'{ny} x {nx}')
...
print('=' * 96)
print('P15-6B0 FINAL RESULT: PASS_EXACT_STAMPS_XY_NEIGHBOUR_CENSUS')
print('=' * 96)
