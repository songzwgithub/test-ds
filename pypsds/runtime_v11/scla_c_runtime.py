...
if img0.size != PUBLIC_NSLAVE:
    raise RuntimeError(f'expected 37 non-master images, got {img0.size}')
...
if len(network) != PUBLIC_NIFG or [x[0] for x in network] != list(range(1, PUBLIC_NIFG + 1)):
    raise RuntimeError('108-IFG network contract failed')
...
print('=' * 92)
print('P15-5B5 FINAL RESULT: PASS_STAMPS_FINAL_PASS_C')
print('=' * 92)
