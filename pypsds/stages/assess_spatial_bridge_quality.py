...
def main():
    ...
    print("=" * 88)
    print(
        "Local spatial bridge-radius quality"
    )
    print("=" * 88)
    ...
    summary = {
        "format":
            "pyPSDS-GAMMA-spatial-radius-quality-v1.0",
    ...
    print()
    print(
        "STEP spatial_bridge_quality STATUS: PASS"
    )
