...
def robust_emi_threaded_v09(
    ...
    *,
    ...
    def work(s: int, e: int):
        return s, e, robust_emi_batch_v09(
            coh[s:e],
            n_images=n_images,
            pairs=pairs,
            beta=beta,
...
def median_pair_coherence_v09(coh: np.ndarray) -> np.ndarray:
