...
def main():
    ...
    ap = argparse.ArgumentParser(
        description=(
            "Audit pyPSDS virtual interferograms "
    ...
    print("=" * 80)
    print(
        "Step 08a - Virtual IFG / closure audit"
    )
    print("=" * 80)
    ...
    # ========================================================
    # Full PointPhaseStack audit
    # ========================================================

    print()
    print(
        "Running full-scene virtual IFG audit..."
    )
    ...
    # ========================================================
    # Reversal identity audit
    # ========================================================

    print()
    print(
        "Running deterministic pair-reversal audit..."
    )
    ...
    summary = {
        "format": "pyPSDS-GAMMA-virtual-ifg-audit-v0.9",
    ...
    manifest_out = (
        qa_dir
        / "virtual_ifg_audit_manifest.json"
    )
