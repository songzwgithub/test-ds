...
def main():
    ...
    print("=" * 104)
    print(
        "Step 08r - SAFE-conflict acquisition attribution audit"
    )
    print("=" * 104)
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-safe-conflict-acquisition-attribution-v0.9",
    ...
    print()
    print(
        "STEP 08r STATUS: PASS / AUDIT ONLY"
    )
