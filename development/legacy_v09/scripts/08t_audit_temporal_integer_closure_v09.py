...
def build_temporal_cycle_basis(
    ...
    A cycle row contains coefficients on the 108 IFGs.
    """
...
def main():
    ...
    audit08r_dir = (
        root
        / "safe_conflict_acquisition_audit"
    )
    ...
    print("=" * 108)
    print(
        "Step 08t - Temporal integer-closure audit "
        "of 108 unwrapped IFGs"
    )
    print("=" * 108)
    ...
    print()
    print(
        "Pass 2/2: auditing spatially varying "
    ...
    # ========================================================
    # Compare with Step08r suspicious points
    # ========================================================
    ...
    if suspicious_edge_path.exists():
        ...
        overlap_info = {
            ...
            "fraction_of_temporal_bad_overlapping_08r":
                (
                    float(
                        overlap.size
                        /
            ...
            "fraction_of_08r_points_temporally_bad":
                (
                    float(
                        overlap.size
                        /
        ...
        print("=" * 108)
        print(
            "Overlap with Step08r spatial "
            "SAFE-conflict points"
        )
        print("=" * 108)

        print(
            f"08r suspicious points      : "
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-temporal-integer-closure-audit-v0.9",
    ...
    json_path = (
        outdir
        / "temporal_integer_closure_audit.json"
    )
    ...
    print()
    print(
        "STEP 08t STATUS: PASS / AUDIT ONLY"
    )
