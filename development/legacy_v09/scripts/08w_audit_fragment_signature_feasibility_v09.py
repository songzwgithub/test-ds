...
def read_bad_point_patterns(
    ...
    """
    Step08u sparse correction CSV contains one or more
...
def main():
    ...
    temporal_dir = (
        root
        / "temporal_integer_closure_audit"
    )
    ...
    # All Step08u points must lie in the main component.
    ...
    # complete 108-IFG safe-fragment membership signature.
    #
    # No [Npoint,108] fragment cube is created.
    # ========================================================
    ...
    print("=" * 112)
    print(
        "Step 08w - Spatiotemporal safe-fragment "
        "signature feasibility audit"
    )
    print("=" * 112)
    ...
    print()
    print(
        "Grouping identical 108-IFG signatures ..."
    )
    ...
    print(
        "B. GOOD + BAD share identical 108-IFG signature"
    )
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-fragment-signature-feasibility-v0.9",
        ...
        "note":
            (
                ...
                "108-IFG safe-fragment membership signature "
                "without persisting an Npoint x Nifg cube. "
                "This is a necessary-condition audit only; "
    ...
    print()
    print(
        "STEP 08w STATUS: PASS / "
        "STRUCTURAL FEASIBILITY AUDIT COMPLETE"
    )
