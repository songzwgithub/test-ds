...
def main():
    ...
    # ========================================================
    # Residual points:
    # Step08t only audited main component.
    #
    # Audit residual points that are registered in ALL IFGs.
    # ========================================================
    ...
    print("=" * 108)
    print(
        "Step 08x - Final unwrap quality mask "
    ...
    print()
    print(
        "Final strict-mask temporal closure audit ..."
    )
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-final-unwrap-candidate-v0.9",
