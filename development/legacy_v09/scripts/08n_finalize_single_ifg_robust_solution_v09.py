...
def main():
    ...
    # --------------------------------------------------------
    # 08l robust local-component solution
    # --------------------------------------------------------
    ...
    print("=" * 92)
    print(
        "Step 08n - Final robust single-IFG candidate"
    )
    print("=" * 92)
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-robust-single-ifg-candidate-v0.9",
    ...
    print()
    print(
        "STEP 08n STATUS: PASS / "
        "SINGLE-IFG ROBUST CANDIDATE"
    )

    print(
        "Do not batch-run 108 IFGs yet."
    )
