...
def find_geometry_mask(v09_dir: Path):
    candidates = [
        v09_dir / "cache" / "phase_geometry_valid.npy",
        v09_dir / "phase_geometry_valid.npy",
        v09_dir / "cache" / "geometry_valid.npy",
        v09_dir / "geometry_valid.npy",
    ]
...
def main():
    ...
    print("=" * 80)
    print(
        "Step 06b - Final PS geometry/phase audit"
    )
    print("=" * 80)
