...
def main():
    ...
    outroot = Path(paths.output_dir) / "v09"
    ...
    anchor_dir = (
        outroot
        / "spatial_graph_two_anchor_audit"
    )
    ...
    print("=" * 88)
    print(
        "Step 08h - Production spatial point graph"
    )
    print("=" * 88)
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-production-spatial-graph-v0.9",
    ...
    print()
    print(
        "STEP 08h STATUS: PASS / SPATIAL GRAPH FROZEN"
    )
