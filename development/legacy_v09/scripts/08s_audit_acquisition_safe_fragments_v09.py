...
def build_safe_forest(
    ...
    No quality sorting is needed for this audit.
    """
...
def main():
    ...
    outdir = (
        root
        / "acquisition_safe_fragment_audit"
    )
    ...
    print("=" * 104)
    print(
        "Step 08s - Acquisition-domain SAFE-fragment audit"
    )
    print("=" * 104)
    ...
    csv_path = (
        outdir
        / "acquisition_safe_fragment_audit.csv"
    )
    ...
    manifest = {
        "format":
            "pyPSDS-GAMMA-acquisition-safe-fragment-audit-v0.9",
    ...
    json_path = (
        outdir
        / "acquisition_safe_fragment_audit.json"
    )
    ...
    print()
    print(
        "STEP 08s STATUS: PASS / AUDIT ONLY"
    )
