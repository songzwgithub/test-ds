...
def main():
    ...
    print("=" * 104)
    print(
        "U3.4a sequential vs 38-date full-SCM phase parity"
    )
    print("=" * 104)
    ...
    report = {
        "format":
            "pyPSDS-GAMMA-U3.4a-sequential-full-phase-parity-v1",
    ...
    print(
        "U3.4a COMPUTATIONAL INTEGRITY: PASS"
    )

    print(
        "U3.4a SCIENTIFIC DECISION: "
