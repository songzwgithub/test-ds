...
def test_project_paths_are_relative_to_project(
    tmp_path,
):
...
def test_optional_dem_and_gacos_do_not_block_core(
    tmp_path,
):
...
def test_explicit_external_auxiliary_paths(
    tmp_path,
):
...
def test_projectpaths_keeps_v1_constructor_compatibility(
    tmp_path,
):
    """
